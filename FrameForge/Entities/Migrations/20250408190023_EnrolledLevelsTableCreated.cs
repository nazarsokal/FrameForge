...
{
    /// <inheritdoc />
    public partial class EnrolledLevelsTableCreated : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropPrimaryKey(
                name: "PK_EnrolledLevels",
                table: "EnrolledLevels");

            migrationBuilder.DeleteData(
                table: "Student",
                keyColumn: "StudentId",
                keyValue: new Guid("b9f8e385-4841-4eb6-b762-c48b8eaf5a0c"));

            migrationBuilder.RenameTable(
                name: "EnrolledLevels",
                newName: "LevelsEnrolled");

            migrationBuilder.AddPrimaryKey(
                name: "PK_LevelsEnrolled",
                table: "LevelsEnrolled",
                column: "LevelsEnrolledKey");

            migrationBuilder.InsertData(
                table: "Student",
                columns: new[] { "StudentId", "Email", "GoogleId", "MoneyAmount", "Password", "Picture", "StarsAmount", "Username" },
                values: new object[] { new Guid("525c1928-744f-4009-8482-2fbfc7f062fe"), "TestUser@test.com", null, 100.45, "TestPassword", null, 0, "TestUserName" });
        }
    }
}
